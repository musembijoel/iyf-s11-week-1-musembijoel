...
- [ ] The link color smoothly transitions to a high-contrast hue (such as a deeper purple/blue or a bright brand-specific accent color) to meet modern accessibility contrast standards
- [ ] For button-like list links (such as dropdown items in the menu), hovering adds a subtle background fill tint (e.g., light gray or translucent dark tint depending on your light/dark system theme selection).
